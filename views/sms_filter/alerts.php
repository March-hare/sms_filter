<div id="content">
	<div class="content-bg">
		...
		<div class="big-block">
			...
			<?php print form::open() ?>
			<div class="step-1">
        <h2><?php echo Kohana::lang('sms_filter.alerts_step1_select_area'); ?></h2>
        <a href="#" id='select_by_region' class='select_area'><?php echo Kohana::lang('sms_filter.alerts_step1_select_region'); ?></a><br />
        <a href="#" id='select_by_radius' class='select_area'><?php echo Kohana::lang('sms_filter.alerts_step1_select_radius'); ?></a>
				<?php echo $alert_region_view; ?>
